...
<body>
	<div id="footer">
		<div id="footer_top">
			<span>시도별 발생현황 <img class="footer_icon" alt="바로가기아이콘" src="./img/footer_icon2.png"></span>
			<span>감염병통계 <img class="footer_icon" alt="바로가기아이콘" src="./img/footer_icon2.png"></span>
			<span>코로나19 병원정보<img class="footer_icon" alt="바로가기아이콘" src="./img/footer_icon2.png"></span>
		</div>
